...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class FEHBAHA1397TableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public FEHBAHA1397TableAdapter()
		{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "FEHBAHA1397";
			...
			_adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[FEHBAHA1397] ([radif], [shomar], [Sharh], [Fasl], [vkod], [Vahed], [baha], [darsad], [setareh], [ItemNoa], [ItemDarsad], [GroupNo], [GroupName], [Selection]) VALUES (@radif, @shomar, @Sharh, @Fasl, @vkod, @Vahed, @baha, @darsad, @setareh, @ItemNoa, @ItemDarsad, @GroupNo, @GroupName, @Selection)";
		...
		private void InitCommandCollection()
		{
			...
			_commandCollection[0].CommandText = "SELECT radif, shomar, Sharh, Fasl, vkod, Vahed, baha, darsad, setareh, ItemNoa, ItemDarsad, GroupNo, GroupName, Selection FROM dbo.FEHBAHA1397";
		...
		public virtual int Fill(GeoBahaDataSet.FEHBAHA1397DataTable dataTable)
		{
		...
		public virtual GeoBahaDataSet.FEHBAHA1397DataTable GetData()
		{
			Adapter.SelectCommand = CommandCollection[0];
			GeoBahaDataSet.FEHBAHA1397DataTable fEHBAHA1397DataTable = new GeoBahaDataSet.FEHBAHA1397DataTable();
			Adapter.Fill(fEHBAHA1397DataTable);
			return fEHBAHA1397DataTable;
		}

		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(GeoBahaDataSet.FEHBAHA1397DataTable dataTable)
		{
		...
		{
			return Adapter.Update(dataSet, "FEHBAHA1397");
		}
