...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class FEHBAHA1387TableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public FEHBAHA1387TableAdapter()
		{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "FEHBAHA1387";
			...
			_adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[FEHBAHA1387] ([radif], [shomar], [Sharh], [Fasl], [vkod], [Vahed], [baha], [darsad], [setareh], [ItemNoa], [ItemDarsad], [GroupNo], [GroupName], [Selection]) VALUES (@radif, @shomar, @Sharh, @Fasl, @vkod, @Vahed, @baha, @darsad, @setareh, @ItemNoa, @ItemDarsad, @GroupNo, @GroupName, @Selection)";
		...
		private void InitCommandCollection()
		{
			...
			_commandCollection[0].CommandText = "SELECT radif, shomar, Sharh, Fasl, vkod, Vahed, baha, darsad, setareh, ItemNoa, ItemDarsad, GroupNo, GroupName, Selection FROM dbo.FEHBAHA1387";
		...
		public virtual int Fill(GeoBahaDataSet.FEHBAHA1387DataTable dataTable)
		{
		...
		public virtual GeoBahaDataSet.FEHBAHA1387DataTable GetData()
		{
			Adapter.SelectCommand = CommandCollection[0];
			GeoBahaDataSet.FEHBAHA1387DataTable fEHBAHA1387DataTable = new GeoBahaDataSet.FEHBAHA1387DataTable();
			Adapter.Fill(fEHBAHA1387DataTable);
			return fEHBAHA1387DataTable;
		}

		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(GeoBahaDataSet.FEHBAHA1387DataTable dataTable)
		{
		...
		{
			return Adapter.Update(dataSet, "FEHBAHA1387");
		}
