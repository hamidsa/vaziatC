...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class FEH1268279393TableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public FEH1268279393TableAdapter()
		{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "FEH1268279393";
			...
			_adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[FEH1268279393] ([radif], [shomar], [Sharh], [Fasl], [vkod], [Vahed], [baha], [darsad], [setareh], [ItemNoa], [ItemDarsad], [GroupNo], [GroupName], [Selection]) VALUES (@radif, @shomar, @Sharh, @Fasl, @vkod, @Vahed, @baha, @darsad, @setareh, @ItemNoa, @ItemDarsad, @GroupNo, @GroupName, @Selection)";
		...
		private void InitCommandCollection()
		{
			...
			_commandCollection[0].CommandText = "SELECT radif, shomar, Sharh, Fasl, vkod, Vahed, baha, darsad, setareh, ItemNoa, ItemDarsad, GroupNo, GroupName, Selection FROM dbo.FEH1268279393";
		...
		public virtual int Fill(GeoBahaDataSet.FEH1268279393DataTable dataTable)
		{
		...
		public virtual GeoBahaDataSet.FEH1268279393DataTable GetData()
		{
			Adapter.SelectCommand = CommandCollection[0];
			GeoBahaDataSet.FEH1268279393DataTable fEH1268279393DataTable = new GeoBahaDataSet.FEH1268279393DataTable();
			Adapter.Fill(fEH1268279393DataTable);
			return fEH1268279393DataTable;
		}

		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(GeoBahaDataSet.FEH1268279393DataTable dataTable)
		{
		...
		{
			return Adapter.Update(dataSet, "FEH1268279393");
		}
