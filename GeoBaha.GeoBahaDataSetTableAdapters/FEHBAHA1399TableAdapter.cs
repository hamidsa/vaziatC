...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class FEHBAHA1399TableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public FEHBAHA1399TableAdapter()
		{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "FEHBAHA1399";
			...
			_adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[FEHBAHA1399] ([radif], [shomar], [Sharh], [Fasl], [vkod], [Vahed], [baha], [darsad], [setareh], [ItemNoa], [ItemDarsad], [GroupNo], [GroupName], [Selection]) VALUES (@radif, @shomar, @Sharh, @Fasl, @vkod, @Vahed, @baha, @darsad, @setareh, @ItemNoa, @ItemDarsad, @GroupNo, @GroupName, @Selection)";
			_adapter.InsertCommand.CommandType = CommandType.Text;
			_adapter.InsertCommand.Parameters.Add(new SqlParameter("@radif", SqlDbType.NVarChar, 0, ParameterDirection.Input, 0, 0, "radif", DataRowVersion.Current, sourceColumnNullMapping: false, null, "", "", ""));
			_adapter.InsertCommand.Parameters.Add(new SqlParameter("@shomar", SqlDbType.NVarChar, 0, ParameterDirection.Input, 0, 0, "shomar", DataRowVersion.Current, sourceColumnNullMapping: false, null, "", "", ""));
			_adapter.InsertCommand.Parameters.Add(new SqlParameter("@Sharh", SqlDbType.NVarChar, 0, ParameterDirection.Input, 0, 0, "Sharh", DataRowVersion.Current, sourceColumnNullMapping: false, null, "", "", ""));
			...
			_adapter.InsertCommand.Parameters.Add(new SqlParameter("@vkod", SqlDbType.Decimal, 0, ParameterDirection.Input, 18, 1, "vkod", DataRowVersion.Current, sourceColumnNullMapping: false, null, "", "", ""));
			_adapter.InsertCommand.Parameters.Add(new SqlParameter("@Vahed", SqlDbType.NVarChar, 0, ParameterDirection.Input, 0, 0, "Vahed", DataRowVersion.Current, sourceColumnNullMapping: false, null, "", "", ""));
			_adapter.InsertCommand.Parameters.Add(new SqlParameter("@baha", SqlDbType.NVarChar, 0, ParameterDirection.Input, 0, 0, "baha", DataRowVersion.Current, sourceColumnNullMapping: false, null, "", "", ""));
			...
			_adapter.InsertCommand.Parameters.Add(new SqlParameter("@GroupName", SqlDbType.NVarChar, 0, ParameterDirection.Input, 0, 0, "GroupName", DataRowVersion.Current, sourceColumnNullMapping: false, null, "", "", ""));
		...
		private void InitCommandCollection()
		{
			...
			_commandCollection[0].CommandText = "SELECT radif, shomar, Sharh, Fasl, vkod, Vahed, baha, darsad, setareh, ItemNoa, ItemDarsad, GroupNo, GroupName, Selection FROM dbo.FEHBAHA1399";
		...
		public virtual int Fill(GeoBahaDataSet.FEHBAHA1399DataTable dataTable)
		{
		...
		public virtual GeoBahaDataSet.FEHBAHA1399DataTable GetData()
		{
			Adapter.SelectCommand = CommandCollection[0];
			GeoBahaDataSet.FEHBAHA1399DataTable fEHBAHA1399DataTable = new GeoBahaDataSet.FEHBAHA1399DataTable();
			Adapter.Fill(fEHBAHA1399DataTable);
			return fEHBAHA1399DataTable;
		}

		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(GeoBahaDataSet.FEHBAHA1399DataTable dataTable)
		{
		...
		{
			return Adapter.Update(dataSet, "FEHBAHA1399");
		}
