...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class Update_asnad2TableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public Update_asnad2TableAdapter()
		{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "Update_asnad2";
			...
			_adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Update_asnad2] ([recnum], [radif], [sanadnum], [itemnum], [sharhitem], [mablagh], [groupnum], [groupname], [fasl], [vahed], [ghvahed], [shvahed], [total], [darsad], [setarehdar], [itemdarsad], [itemname], [molahezat], [fopf], [SalMali], [IjadSystem], [EslahSystem], [TimeIjad], [TimeEslah]) VALUES (@recnum, @radif, @sanadnum, @itemnum, @sharhitem, @mablagh, @groupnum, @groupname, @fasl, @vahed, @ghvahed, @shvahed, @total, @darsad, @setarehdar, @itemdarsad, @itemname, @molahezat, @fopf, @SalMali, @IjadSystem, @EslahSystem, @TimeIjad, @TimeEslah)";
		...
		private void InitCommandCollection()
		{
			...
			_commandCollection[0].CommandText = "SELECT recnum, radif, sanadnum, itemnum, sharhitem, mablagh, groupnum, groupname, fasl, vahed, ghvahed, shvahed, total, darsad, setarehdar, itemdarsad, itemname, molahezat, fopf, SalMali, IjadSystem, EslahSystem, TimeIjad, TimeEslah FROM dbo.Update_asnad2";
		...
		public virtual int Fill(GeoBahaDataSet.Update_asnad2DataTable dataTable)
		{
		...
		public virtual GeoBahaDataSet.Update_asnad2DataTable GetData()
		{
			Adapter.SelectCommand = CommandCollection[0];
			GeoBahaDataSet.Update_asnad2DataTable update_asnad2DataTable = new GeoBahaDataSet.Update_asnad2DataTable();
			Adapter.Fill(update_asnad2DataTable);
			return update_asnad2DataTable;
		}

		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(GeoBahaDataSet.Update_asnad2DataTable dataTable)
		{
		...
		{
			return Adapter.Update(dataSet, "Update_asnad2");
		}
