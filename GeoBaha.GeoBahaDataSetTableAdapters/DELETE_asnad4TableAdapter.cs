...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class DELETE_asnad4TableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public DELETE_asnad4TableAdapter()
		{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "DELETE_asnad4";
			...
			_adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[DELETE_asnad4] ([recnum], [sanadnum], [fopf], [Sharh], [darsad], [maghtoo], [mablagh], [mablaghk], [Salmali], [IjadSystem], [EslahSystem], [TimeIjad], [TimeEslah], [DeleteSystem], [TimeDelete]) VALUES (@recnum, @sanadnum, @fopf, @Sharh, @darsad, @maghtoo, @mablagh, @mablaghk, @Salmali, @IjadSystem, @EslahSystem, @TimeIjad, @TimeEslah, @DeleteSystem, @TimeDelete)";
		...
		private void InitCommandCollection()
		{
			...
			_commandCollection[0].CommandText = "SELECT recnum, sanadnum, fopf, Sharh, darsad, maghtoo, mablagh, mablaghk, Salmali, IjadSystem, EslahSystem, TimeIjad, TimeEslah, DeleteSystem, TimeDelete FROM dbo.DELETE_asnad4";
		...
		public virtual int Fill(GeoBahaDataSet.DELETE_asnad4DataTable dataTable)
		{
		...
		public virtual GeoBahaDataSet.DELETE_asnad4DataTable GetData()
		{
			Adapter.SelectCommand = CommandCollection[0];
			GeoBahaDataSet.DELETE_asnad4DataTable dELETE_asnad4DataTable = new GeoBahaDataSet.DELETE_asnad4DataTable();
			Adapter.Fill(dELETE_asnad4DataTable);
			return dELETE_asnad4DataTable;
		}

		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(GeoBahaDataSet.DELETE_asnad4DataTable dataTable)
		{
		...
		{
			return Adapter.Update(dataSet, "DELETE_asnad4");
		}
		...
		public virtual int Insert(decimal recnum, decimal sanadnum, bool fopf, string Sharh, double? darsad, double? maghtoo, double? mablagh, double? mablaghk, string Salmali, string IjadSystem, string EslahSystem, DateTime? TimeIjad, DateTime? TimeEslah, string DeleteSystem, DateTime? TimeDelete)
		{
			...
			{
				Adapter.InsertCommand.Parameters[13].Value = DeleteSystem;
			}
			if (TimeDelete.HasValue)
			{
				Adapter.InsertCommand.Parameters[14].Value = TimeDelete.Value;
			}
			else
			{
