...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class Select_DafaterVaBakhshhaTableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public Select_DafaterVaBakhshhaTableAdapter()
		{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "Select_DafaterVaBakhshha";
		...
		private void InitCommandCollection()
		{
			...
			_commandCollection[0].CommandText = "dbo.Select_DafaterVaBakhshha";
		...
		public virtual int Fill(GeoBahaDataSet.Select_DafaterVaBakhshhaDataTable dataTable)
		{
		...
		public virtual GeoBahaDataSet.Select_DafaterVaBakhshhaDataTable GetData()
		{
			Adapter.SelectCommand = CommandCollection[0];
			GeoBahaDataSet.Select_DafaterVaBakhshhaDataTable select_DafaterVaBakhshhaDataTable = new GeoBahaDataSet.Select_DafaterVaBakhshhaDataTable();
			Adapter.Fill(select_DafaterVaBakhshhaDataTable);
			return select_DafaterVaBakhshhaDataTable;
		}
	}
}
