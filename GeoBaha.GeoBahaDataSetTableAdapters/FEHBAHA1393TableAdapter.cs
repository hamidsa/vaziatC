...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class FEHBAHA1393TableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public FEHBAHA1393TableAdapter()
		{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "FEHBAHA1393";
			...
			_adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[FEHBAHA1393] ([radif], [shomar], [Sharh], [Fasl], [vkod], [Vahed], [baha], [darsad], [setareh], [ItemNoa], [ItemDarsad], [GroupNo], [GroupName], [Selection]) VALUES (@radif, @shomar, @Sharh, @Fasl, @vkod, @Vahed, @baha, @darsad, @setareh, @ItemNoa, @ItemDarsad, @GroupNo, @GroupName, @Selection)";
		...
		private void InitCommandCollection()
		{
			...
			_commandCollection[0].CommandText = "SELECT radif, shomar, Sharh, Fasl, vkod, Vahed, baha, darsad, setareh, ItemNoa, ItemDarsad, GroupNo, GroupName, Selection FROM dbo.FEHBAHA1393";
		...
		public virtual int Fill(GeoBahaDataSet.FEHBAHA1393DataTable dataTable)
		{
		...
		public virtual GeoBahaDataSet.FEHBAHA1393DataTable GetData()
		{
			Adapter.SelectCommand = CommandCollection[0];
			GeoBahaDataSet.FEHBAHA1393DataTable fEHBAHA1393DataTable = new GeoBahaDataSet.FEHBAHA1393DataTable();
			Adapter.Fill(fEHBAHA1393DataTable);
			return fEHBAHA1393DataTable;
		}

		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(GeoBahaDataSet.FEHBAHA1393DataTable dataTable)
		{
		...
		{
			return Adapter.Update(dataSet, "FEHBAHA1393");
		}
