...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class Update_asnad1TableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public Update_asnad1TableAdapter()
		{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "Update_asnad1";
			...
			_adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Update_asnad1] ([recnum], [radif], [sanadnum], [karnum], [pkod], [sanaddatey], [sanaddatem], [sanaddated], [fehkod], [forpf], [mablaghk], [pname1], [karkod1], [karname1], [Karname2], [fehrest], [noeSanad], [Salmali], [zarib], [Nameh], [fehrestfile], [Pname2], [Ronevwsht], [Printed], [IjadSystem], [EslahSystem], [TimeIjad], [TimeEslah]) VALUES (@recnum, @radif, @sanadnum, @karnum, @pkod, @sanaddatey, @sanaddatem, @sanaddated, @fehkod, @forpf, @mablaghk, @pname1, @karkod1, @karname1, @Karname2, @fehrest, @noeSanad, @Salmali, @zarib, @Nameh, @fehrestfile, @Pname2, @Ronevwsht, @Printed, @IjadSystem, @EslahSystem, @TimeIjad, @TimeEslah)";
		...
		private void InitCommandCollection()
		{
			...
			_commandCollection[0].CommandText = "SELECT recnum, radif, sanadnum, karnum, pkod, sanaddatey, sanaddatem, sanaddated, fehkod, forpf, mablaghk, pname1, karkod1, karname1, Karname2, fehrest, noeSanad, Salmali, zarib, Nameh, fehrestfile, Pname2, Ronevwsht, Printed, IjadSystem, EslahSystem, TimeIjad, TimeEslah FROM dbo.Update_asnad1";
		...
		public virtual int Fill(GeoBahaDataSet.Update_asnad1DataTable dataTable)
		{
		...
		public virtual GeoBahaDataSet.Update_asnad1DataTable GetData()
		{
			Adapter.SelectCommand = CommandCollection[0];
			GeoBahaDataSet.Update_asnad1DataTable update_asnad1DataTable = new GeoBahaDataSet.Update_asnad1DataTable();
			Adapter.Fill(update_asnad1DataTable);
			return update_asnad1DataTable;
		}

		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(GeoBahaDataSet.Update_asnad1DataTable dataTable)
		{
		...
		{
			return Adapter.Update(dataSet, "Update_asnad1");
		}
