...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class etvahedTableAdapter : Component
	{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "etvahed";
			...
			_adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[etvahed] ([vkod], [vahed], [fehrest], [fehname]) VALUES (@vkod, @vahed, @fehrest, @fehname)";
		...
		private void InitCommandCollection()
		{
			...
			_commandCollection[0].CommandText = "SELECT identradif, vkod, vahed, fehrest, fehname FROM dbo.etvahed";
		...
		public virtual int Fill(GeoBahaDataSet.etvahedDataTable dataTable)
		{
		...
		public virtual GeoBahaDataSet.etvahedDataTable GetData()
		{
			Adapter.SelectCommand = CommandCollection[0];
			GeoBahaDataSet.etvahedDataTable etvahedDataTable = new GeoBahaDataSet.etvahedDataTable();
			Adapter.Fill(etvahedDataTable);
			return etvahedDataTable;
		}

		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(GeoBahaDataSet.etvahedDataTable dataTable)
		{
		...
		{
			return Adapter.Update(dataSet, "etvahed");
		}
		...
		public virtual int Insert(decimal vkod, string vahed, string fehrest, string fehname)
		{
			Adapter.InsertCommand.Parameters[0].Value = vkod;
			if (vahed == null)
			{
				throw new ArgumentNullException("vahed");
			}
			Adapter.InsertCommand.Parameters[1].Value = vahed;
			if (fehrest == null)
			{
			...
			{
				Adapter.InsertCommand.Parameters[2].Value = fehrest;
			}
			if (fehname == null)
			{
			...
			{
				Adapter.InsertCommand.Parameters[3].Value = fehname;
			}
