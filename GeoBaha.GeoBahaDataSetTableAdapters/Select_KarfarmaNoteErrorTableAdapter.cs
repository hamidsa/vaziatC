...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class Select_KarfarmaNoteErrorTableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public Select_KarfarmaNoteErrorTableAdapter()
		{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "Select_KarfarmaNoteError";
			dataTableMapping.ColumnMappings.Add("NotError", "NotError");
		...
		private void InitCommandCollection()
		{
			...
			_commandCollection[0].CommandText = "dbo.Select_KarfarmaNoteError";
			...
			_commandCollection[0].Parameters.Add(new SqlParameter("@sanadnum", SqlDbType.Decimal, 9, ParameterDirection.Input, 18, 0, null, DataRowVersion.Current, sourceColumnNullMapping: false, null, "", "", ""));
		...
		public virtual int Fill(GeoBahaDataSet.Select_KarfarmaNoteErrorDataTable dataTable, decimal? sanadnum, bool? forpf, string Salmali)
		{
		...
		public virtual GeoBahaDataSet.Select_KarfarmaNoteErrorDataTable GetData(decimal? sanadnum, bool? forpf, string Salmali)
		{
			Adapter.SelectCommand = CommandCollection[0];
			if (sanadnum.HasValue)
			{
			...
			GeoBahaDataSet.Select_KarfarmaNoteErrorDataTable select_KarfarmaNoteErrorDataTable = new GeoBahaDataSet.Select_KarfarmaNoteErrorDataTable();
			Adapter.Fill(select_KarfarmaNoteErrorDataTable);
			return select_KarfarmaNoteErrorDataTable;
		}
	}
}
