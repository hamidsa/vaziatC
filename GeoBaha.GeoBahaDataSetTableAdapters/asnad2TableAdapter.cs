...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class asnad2TableAdapter : Component
	{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "asnad2";
			...
			_adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[asnad2] ([radif], [sanadnum], [itemnum], [sharhitem], [mablagh], [groupnum], [groupname], [fasl], [vahed], [ghvahed], [shvahed], [total], [darsad], [setarehdar], [itemdarsad], [itemname], [molahezat], [fopf], [SalMali], [IjadSystem], [EslahSystem], [TimeIjad], [TimeEslah], [KodDafaterVaBakhsh], [NameDafaterVaBakhsh], [KodGroup], [NameGroup], [Mablaghi], [NesbatbeMablagh], [Soori], [Ghaleb]) VALUES (@radif, @sanadnum, @itemnum, @sharhitem, @mablagh, @groupnum, @groupname, @fasl, @vahed, @ghvahed, @shvahed, @total, @darsad, @setarehdar, @itemdarsad, @itemname, @molahezat, @fopf, @SalMali, @IjadSystem, @EslahSystem, @TimeIjad, @TimeEslah, @KodDafaterVaBakhsh, @NameDafaterVaBakhsh, @KodGroup, @NameGroup, @Mablaghi, @NesbatbeMablagh, @Soori, @Ghaleb)";
			...
			_adapter.InsertCommand.Parameters.Add(new SqlParameter("@Mablaghi", SqlDbType.Bit, 0, ParameterDirection.Input, 0, 0, "Mablaghi", DataRowVersion.Current, sourceColumnNullMapping: false, null, "", "", ""));
			_adapter.InsertCommand.Parameters.Add(new SqlParameter("@NesbatbeMablagh", SqlDbType.VarChar, 0, ParameterDirection.Input, 0, 0, "NesbatbeMablagh", DataRowVersion.Current, sourceColumnNullMapping: false, null, "", "", ""));
		...
		public virtual int Fill(GeoBahaDataSet.asnad2DataTable dataTable)
		{
		...
		public virtual GeoBahaDataSet.asnad2DataTable GetData()
		{
			Adapter.SelectCommand = CommandCollection[0];
			GeoBahaDataSet.asnad2DataTable asnad2DataTable = new GeoBahaDataSet.asnad2DataTable();
			Adapter.Fill(asnad2DataTable);
			return asnad2DataTable;
		}

		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(GeoBahaDataSet.asnad2DataTable dataTable)
		{
		...
		{
			return Adapter.Update(dataSet, "asnad2");
		}
		...
		public virtual int Insert(string radif, decimal sanadnum, string itemnum, string sharhitem, double mablagh, string groupnum, string groupname, string fasl, decimal vahed, double ghvahed, string shvahed, double total, bool darsad, bool setarehdar, decimal itemdarsad, string itemname, string molahezat, bool fopf, string SalMali, string IjadSystem, string EslahSystem, DateTime? TimeIjad, DateTime? TimeEslah, string KodDafaterVaBakhsh, string NameDafaterVaBakhsh, string KodGroup, string NameGroup, bool? Mablaghi, string NesbatbeMablagh, bool? Soori, bool? Ghaleb)
		{
			...
			Adapter.InsertCommand.Parameters[2].Value = itemnum;
			if (sharhitem == null)
			{
				throw new ArgumentNullException("sharhitem");
			}
			Adapter.InsertCommand.Parameters[3].Value = sharhitem;
			Adapter.InsertCommand.Parameters[4].Value = mablagh;
			if (groupnum == null)
			{
				throw new ArgumentNullException("groupnum");
			}
			Adapter.InsertCommand.Parameters[5].Value = groupnum;
			if (groupname == null)
			{
				throw new ArgumentNullException("groupname");
			}
			Adapter.InsertCommand.Parameters[6].Value = groupname;
			if (fasl == null)
			{
				throw new ArgumentNullException("fasl");
			}
			Adapter.InsertCommand.Parameters[7].Value = fasl;
			Adapter.InsertCommand.Parameters[8].Value = vahed;
			Adapter.InsertCommand.Parameters[9].Value = ghvahed;
			if (shvahed == null)
			{
				throw new ArgumentNullException("shvahed");
			}
			Adapter.InsertCommand.Parameters[10].Value = shvahed;
			Adapter.InsertCommand.Parameters[11].Value = total;
			Adapter.InsertCommand.Parameters[12].Value = darsad;
			Adapter.InsertCommand.Parameters[13].Value = setarehdar;
			Adapter.InsertCommand.Parameters[14].Value = itemdarsad;
			if (itemname == null)
			{
				throw new ArgumentNullException("itemname");
			}
			Adapter.InsertCommand.Parameters[15].Value = itemname;
			if (molahezat == null)
			{
				throw new ArgumentNullException("molahezat");
			}
			Adapter.InsertCommand.Parameters[16].Value = molahezat;
			Adapter.InsertCommand.Parameters[17].Value = fopf;
			if (SalMali == null)
			{
				throw new ArgumentNullException("SalMali");
			}
			Adapter.InsertCommand.Parameters[18].Value = SalMali;
			if (IjadSystem == null)
			{
			...
			{
				Adapter.InsertCommand.Parameters[19].Value = IjadSystem;
			}
			if (EslahSystem == null)
			{
			...
			{
				Adapter.InsertCommand.Parameters[20].Value = EslahSystem;
			}
			if (TimeIjad.HasValue)
			{
				Adapter.InsertCommand.Parameters[21].Value = TimeIjad.Value;
			}
			else
			{
			...
			{
				Adapter.InsertCommand.Parameters[22].Value = TimeEslah.Value;
			}
			else
			{
			...
			{
				Adapter.InsertCommand.Parameters[23].Value = KodDafaterVaBakhsh;
			}
			...
			{
				Adapter.InsertCommand.Parameters[24].Value = NameDafaterVaBakhsh;
			}
			if (KodGroup == null)
			{
			...
			{
				Adapter.InsertCommand.Parameters[25].Value = KodGroup;
			}
			if (NameGroup == null)
			{
			...
			{
				Adapter.InsertCommand.Parameters[26].Value = NameGroup;
			}
			if (Mablaghi.HasValue)
			{
				Adapter.InsertCommand.Parameters[27].Value = Mablaghi.Value;
			}
			else
			{
				Adapter.InsertCommand.Parameters[27].Value = DBNull.Value;
			}
			if (NesbatbeMablagh == null)
			{
				Adapter.InsertCommand.Parameters[28].Value = DBNull.Value;
			}
			else
			{
				Adapter.InsertCommand.Parameters[28].Value = NesbatbeMablagh;
			}
			if (Soori.HasValue)
			{
				Adapter.InsertCommand.Parameters[29].Value = Soori.Value;
			}
			else
			{
			...
			if (Ghaleb.HasValue)
			{
				Adapter.InsertCommand.Parameters[30].Value = Ghaleb.Value;
			}
			else
			{
