...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class Select_ProjectTableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public Select_ProjectTableAdapter()
		{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "Select_Project";
			...
			dataTableMapping.ColumnMappings.Add("ostan_Shahr_Bakhsh", "ostan_Shahr_Bakhsh");
		...
		private void InitCommandCollection()
		{
			...
			_commandCollection[0].CommandText = "dbo.Select_Project";
		...
		public virtual int Fill(GeoBahaDataSet.Select_ProjectDataTable dataTable)
		{
		...
		public virtual GeoBahaDataSet.Select_ProjectDataTable GetData()
		{
			Adapter.SelectCommand = CommandCollection[0];
			GeoBahaDataSet.Select_ProjectDataTable select_ProjectDataTable = new GeoBahaDataSet.Select_ProjectDataTable();
			Adapter.Fill(select_ProjectDataTable);
			return select_ProjectDataTable;
		}
	}
}
