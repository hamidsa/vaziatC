...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class _EshkalProjectBakhshTableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public _EshkalProjectBakhshTableAdapter()
		{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "_EshkalProjectBakhsh";
		...
		private void InitCommandCollection()
		{
			...
			_commandCollection[0].CommandText = "dbo.[_EshkalProjectBakhsh]";
		...
		public virtual int Fill(GeoBahaDataSet._EshkalProjectBakhshDataTable dataTable)
		{
		...
		public virtual GeoBahaDataSet._EshkalProjectBakhshDataTable GetData()
		{
			Adapter.SelectCommand = CommandCollection[0];
			GeoBahaDataSet._EshkalProjectBakhshDataTable eshkalProjectBakhshDataTable = new GeoBahaDataSet._EshkalProjectBakhshDataTable();
			Adapter.Fill(eshkalProjectBakhshDataTable);
			return eshkalProjectBakhshDataTable;
		}
	}
}
