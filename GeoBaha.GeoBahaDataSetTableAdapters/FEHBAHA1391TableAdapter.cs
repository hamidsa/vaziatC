...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class FEHBAHA1391TableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public FEHBAHA1391TableAdapter()
		{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "FEHBAHA1391";
			...
			_adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[FEHBAHA1391] ([radif], [shomar], [Sharh], [Fasl], [vkod], [Vahed], [baha], [darsad], [setareh], [ItemNoa], [ItemDarsad], [GroupNo], [GroupName], [Selection]) VALUES (@radif, @shomar, @Sharh, @Fasl, @vkod, @Vahed, @baha, @darsad, @setareh, @ItemNoa, @ItemDarsad, @GroupNo, @GroupName, @Selection)";
		...
		private void InitCommandCollection()
		{
			...
			_commandCollection[0].CommandText = "SELECT radif, shomar, Sharh, Fasl, vkod, Vahed, baha, darsad, setareh, ItemNoa, ItemDarsad, GroupNo, GroupName, Selection FROM dbo.FEHBAHA1391";
		...
		public virtual int Fill(GeoBahaDataSet.FEHBAHA1391DataTable dataTable)
		{
		...
		public virtual GeoBahaDataSet.FEHBAHA1391DataTable GetData()
		{
			Adapter.SelectCommand = CommandCollection[0];
			GeoBahaDataSet.FEHBAHA1391DataTable fEHBAHA1391DataTable = new GeoBahaDataSet.FEHBAHA1391DataTable();
			Adapter.Fill(fEHBAHA1391DataTable);
			return fEHBAHA1391DataTable;
		}

		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(GeoBahaDataSet.FEHBAHA1391DataTable dataTable)
		{
		...
		{
			return Adapter.Update(dataSet, "FEHBAHA1391");
		}
