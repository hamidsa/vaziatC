...
namespace GeoBaha.GeoBahaDataSetTableAdapters
{
	...
	public class DELETE_asnad1TableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public DELETE_asnad1TableAdapter()
		{
		...
		private void InitAdapter()
		{
			...
			dataTableMapping.DataSetTable = "DELETE_asnad1";
			...
			_adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[DELETE_asnad1] ([recnum], [radif], [sanadnum], [karnum], [pkod], [sanaddatey], [sanaddatem], [sanaddated], [fehkod], [forpf], [mablaghk], [pname1], [karkod1], [karname1], [Karname2], [fehrest], [noeSanad], [Salmali], [zarib], [Nameh], [fehrestfile], [Pname2], [Ronevwsht], [Printed], [IjadSystem], [EslahSystem], [TimeIjad], [TimeEslah], [DeleteSystem], [TimeDelete]) VALUES (@recnum, @radif, @sanadnum, @karnum, @pkod, @sanaddatey, @sanaddatem, @sanaddated, @fehkod, @forpf, @mablaghk, @pname1, @karkod1, @karname1, @Karname2, @fehrest, @noeSanad, @Salmali, @zarib, @Nameh, @fehrestfile, @Pname2, @Ronevwsht, @Printed, @IjadSystem, @EslahSystem, @TimeIjad, @TimeEslah, @DeleteSystem, @TimeDelete)";
		...
		private void InitCommandCollection()
		{
			...
			_commandCollection[0].CommandText = "SELECT recnum, radif, sanadnum, karnum, pkod, sanaddatey, sanaddatem, sanaddated, fehkod, forpf, mablaghk, pname1, karkod1, karname1, Karname2, fehrest, noeSanad, Salmali, zarib, Nameh, fehrestfile, Pname2, Ronevwsht, Printed, IjadSystem, EslahSystem, TimeIjad, TimeEslah, DeleteSystem, TimeDelete FROM dbo.DELETE_asnad1";
		...
		public virtual int Fill(GeoBahaDataSet.DELETE_asnad1DataTable dataTable)
		{
		...
		public virtual GeoBahaDataSet.DELETE_asnad1DataTable GetData()
		{
			Adapter.SelectCommand = CommandCollection[0];
			GeoBahaDataSet.DELETE_asnad1DataTable dELETE_asnad1DataTable = new GeoBahaDataSet.DELETE_asnad1DataTable();
			Adapter.Fill(dELETE_asnad1DataTable);
			return dELETE_asnad1DataTable;
		}

		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(GeoBahaDataSet.DELETE_asnad1DataTable dataTable)
		{
		...
		{
			return Adapter.Update(dataSet, "DELETE_asnad1");
		}
		...
		public virtual int Insert(decimal recnum, string radif, decimal sanadnum, string karnum, decimal pkod, string sanaddatey, string sanaddatem, string sanaddated, decimal fehkod, bool forpf, double mablaghk, string pname1, decimal karkod1, string karname1, string Karname2, string fehrest, string noeSanad, string Salmali, string zarib, string Nameh, string fehrestfile, string Pname2, string Ronevwsht, bool Printed, string IjadSystem, string EslahSystem, DateTime? TimeIjad, DateTime? TimeEslah, string DeleteSystem, DateTime? TimeDelete)
		{
			...
			Adapter.InsertCommand.Parameters[3].Value = karnum;
			Adapter.InsertCommand.Parameters[4].Value = pkod;
			if (sanaddatey == null)
			{
				throw new ArgumentNullException("sanaddatey");
			}
			Adapter.InsertCommand.Parameters[5].Value = sanaddatey;
			if (sanaddatem == null)
			{
				throw new ArgumentNullException("sanaddatem");
			}
			Adapter.InsertCommand.Parameters[6].Value = sanaddatem;
			if (sanaddated == null)
			{
				throw new ArgumentNullException("sanaddated");
			}
			Adapter.InsertCommand.Parameters[7].Value = sanaddated;
			Adapter.InsertCommand.Parameters[8].Value = fehkod;
			Adapter.InsertCommand.Parameters[9].Value = forpf;
			Adapter.InsertCommand.Parameters[10].Value = mablaghk;
			if (pname1 == null)
			{
				throw new ArgumentNullException("pname1");
			}
			Adapter.InsertCommand.Parameters[11].Value = pname1;
			Adapter.InsertCommand.Parameters[12].Value = karkod1;
			if (karname1 == null)
			{
				throw new ArgumentNullException("karname1");
			}
			Adapter.InsertCommand.Parameters[13].Value = karname1;
			if (Karname2 == null)
			{
			...
			{
				Adapter.InsertCommand.Parameters[14].Value = Karname2;
			}
			if (fehrest == null)
			{
				throw new ArgumentNullException("fehrest");
			}
			Adapter.InsertCommand.Parameters[15].Value = fehrest;
			if (noeSanad == null)
			{
				throw new ArgumentNullException("noeSanad");
			}
			Adapter.InsertCommand.Parameters[16].Value = noeSanad;
			if (Salmali == null)
			{
				throw new ArgumentNullException("Salmali");
			}
			Adapter.InsertCommand.Parameters[17].Value = Salmali;
			if (zarib == null)
			{
				throw new ArgumentNullException("zarib");
			}
			Adapter.InsertCommand.Parameters[18].Value = zarib;
			if (Nameh == null)
			{
			...
			{
				Adapter.InsertCommand.Parameters[19].Value = Nameh;
			}
			if (fehrestfile == null)
			{
				throw new ArgumentNullException("fehrestfile");
			}
			Adapter.InsertCommand.Parameters[20].Value = fehrestfile;
			if (Pname2 == null)
			{
			...
			{
				Adapter.InsertCommand.Parameters[21].Value = Pname2;
			}
			if (Ronevwsht == null)
			{
				throw new ArgumentNullException("Ronevwsht");
			}
			Adapter.InsertCommand.Parameters[22].Value = Ronevwsht;
			Adapter.InsertCommand.Parameters[23].Value = Printed;
			if (IjadSystem == null)
			{
			...
			{
				Adapter.InsertCommand.Parameters[24].Value = IjadSystem;
			}
			if (EslahSystem == null)
			{
			...
			{
				Adapter.InsertCommand.Parameters[25].Value = EslahSystem;
			}
			if (TimeIjad.HasValue)
			{
				Adapter.InsertCommand.Parameters[26].Value = TimeIjad.Value;
			}
			else
			{
			...
			{
				Adapter.InsertCommand.Parameters[27].Value = TimeEslah.Value;
			}
			else
			{
			...
			{
				Adapter.InsertCommand.Parameters[28].Value = DeleteSystem;
			}
			if (TimeDelete.HasValue)
			{
				Adapter.InsertCommand.Parameters[29].Value = TimeDelete.Value;
			}
			else
			{
